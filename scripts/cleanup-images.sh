#!/bin/bash
# Clean up Sail Operator images from cluster nodes using Eraser
...
# What gets cleaned:
#   - Sail Operator image
#   - Istio images (pilot, proxy, cni, ztunnel, must-gather)

set -e

INSTALL_ERASER=false
ERASER_NAMESPACE="eraser-system"
IMAGELIST_NAME="sail-operator-cleanup"
...
echo "============================================"
echo "  Sail Operator Image Cleanup"
echo "============================================"
echo ""
...
echo ""
echo "  - registry.redhat.io/openshift-service-mesh/istio-rhel9-operator"
echo "  - registry.redhat.io/openshift-service-mesh/istio-pilot-rhel9"
echo "  - registry.redhat.io/openshift-service-mesh/istio-proxyv2-rhel9"
echo "  - registry.redhat.io/openshift-service-mesh/istio-cni-rhel9"
echo "  - registry.redhat.io/openshift-service-mesh/istio-ztunnel-rhel9"
echo "  - registry.redhat.io/openshift-service-mesh/istio-must-gather-rhel9"
echo "  - registry.redhat.io/openshift-service-mesh-tech-preview/istio-ztunnel-rhel9"
echo "  - registry.redhat.io/openshift-service-mesh-dev-preview-beta/istio-ztunnel-rhel9"
echo ""
...
kind: ImageList
metadata:
  name: sail-operator-cleanup
spec:
  images:
    # Sail Operator
    - registry.redhat.io/openshift-service-mesh/istio-rhel9-operator
    # Istio images
    - registry.redhat.io/openshift-service-mesh/istio-pilot-rhel9
    - registry.redhat.io/openshift-service-mesh/istio-proxyv2-rhel9
    - registry.redhat.io/openshift-service-mesh/istio-cni-rhel9
    - registry.redhat.io/openshift-service-mesh/istio-ztunnel-rhel9
    - registry.redhat.io/openshift-service-mesh/istio-must-gather-rhel9
    # Tech preview / dev preview ztunnel
    - registry.redhat.io/openshift-service-mesh-tech-preview/istio-ztunnel-rhel9
    - registry.redhat.io/openshift-service-mesh-dev-preview-beta/istio-ztunnel-rhel9
EOF
